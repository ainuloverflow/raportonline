          ...
          <section class="wrapper">            
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
                                            <li><i class="icon_documents"></i><a href="<?php echo $url;?>list-siswa"><?php echo $breadcrumb;?></a></li>					  	
					</ol>
				</div>
			</div>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" action="<?php echo $url;?>validasi-edit-siswa" method="post">
                                  ...
                                  <input type="text" value="<?php echo $validasi->value('id_siswa');?>" name="id_siswa" class="form-control round-input hidden">

                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">NIS Siswa</label>
                                      <div class="col-sm-7"> <!--validasi nis edit siswa-->
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-7"> <!--validasi id orangtua untuk siswa-->
                                            <p><?php echo $validasi->errorMessages('id_orangtua', '<p style="color:red">', '</p>');?></p>
                                            <input id="id_orangtua" name="id_orangtua" type="text" value="<?php echo $validasi->value('id_orangtua');?>" class="form-control round-input">
                                      </div>
                                  </div>
                                  
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Nama</label>
                                      <div class="col-sm-7"> <!--validasi nama siswa-->
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            <select name="jenkel" value="" class="btn btn-default dropdown-toggle">
                                                <option value="<?php echo $validasi->value('jenkel');?>"><?php echo $validasi->value('jenkel');?></option>
                                                <option value=""></option>
