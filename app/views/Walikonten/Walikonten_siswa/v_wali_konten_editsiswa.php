                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" action="<?php echo $url;?>validasi-edit-siswa" method="post">
                                  ...
                                  <input type="text" value="<?php echo $editsiswa->ID_SISWA;?>" name="id_siswa" class="form-control round-input hidden">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-7">
                                            <input id="id_orangtua" name="id_orangtua" type="text" value="<?php echo $editsiswa->ID_ORANGTUA." - ".$editsiswa->NIK_AYAH." - ".$editsiswa->NAMA_AYAH." - ".$editsiswa->NIK_IBU." - ".$editsiswa->NAMA_IBU;?>"  class="form-control round-input">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-7">
                                            <input type="text" value="<?php echo $editsiswa->TEMPAT_LAHIR_SISWA;?>" name="tempat_lahir_siswa" class="form-control round-input">
                                      </div>
                                  </div>
