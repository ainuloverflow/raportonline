                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" action="<?php echo $url;?>validasi-edit-kd" method="post">
                                  ...
                                  <br>
                                  <input type="text" value="<?php echo $validasi->value('id_kopdar');?>" name="id_kopdar" class="form-control round-input hidden">
                                      ...
                                      <label class="col-sm-2 control-label">Pilih KI-3(Pengetahuan)</label>
                                        <div class="col-sm-5">
                                            <select name="ki-3" class="btn btn-default dropdown-toggle">
                                                ...
                                                <option value="<?php echo $validasi->value('ki-3');?>"><?php echo $validasi->value('ki-3');?></option>
                                                <option></option>
                                  ...
                                  <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              ...
                                              <textarea class="form-control " id="deskripsi" name="deskripsiki-3"><?php echo $validasi->value('deskripsiki-3');?></textarea>
                                          </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            <select name="ki-4" class="btn btn-default dropdown-toggle">
                                                <option><?php echo $validasi->value('ki-4');?></option>
                                                <option></option>
                                  ...
                                  <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              ...
                                              <textarea class="form-control" id="deskripsi" name="deskripsiki-4"><?php echo $validasi->value('dekripsiki-4');?></textarea>
                                          </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            <select name="ki-1" class="btn btn-default dropdown-toggle">
                                                <option><?php echo $validasi->value('ki-1');?></option>
                                                <option></option>
                                                <?php $x=20;?>
                                                <?php for($i=1;$i<=$x;$i++){?>
                                  ...
                                  <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              ...
                                              <textarea class="form-control" id="deskripsi" name="deskripsiki-1"><?php echo $validasi->value('deskripsiki-1');?></textarea>
                                          </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            <select name="ki-2" class="btn btn-default dropdown-toggle">
                                                <option><?php echo $validasi->value('ki-2');?></option>
                                                <option></option>
                                                <?php $x=20;?>
                                                <?php for($i=1;$i<=$x;$i++){?>
                                                <option value="<?php echo $i;?>"><?php echo $i;?></option>
                                  ...
                                  <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              ...
                                              <textarea class="form-control" id="deskripsi" name="deskripsiki-2"><?php echo $validasi->value('deskripsiki-2');?></textarea>
                                          </div>
                                  </div>
