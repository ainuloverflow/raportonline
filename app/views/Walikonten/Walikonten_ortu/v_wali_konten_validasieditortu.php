                              ...
                              <form class="form-horizontal" action="<?php echo $url;?>validasieditortu" method="post">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-7">
                                          ...
                                          <input type="text" id="nama_siswa" value="<?php echo $validasi->value('nama_siswa');?>" name="nama_siswa" placeholder="Ketikan Nama atau NIK Siswa" class="form-control round-input">
                                      </div>
                                  </div>
