                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" action="<?php echo $url;?>validasieditortu" method="post">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-7">
                                          <input id="nama_siswa" name="nama_siswa" type="text" value="<?php echo $editortu->ID_SISWA;?>" placeholder="Ketikan Nama atau NIK Siswa" class="form-control round-input">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-7">
                                          <input type="text" value="<?php echo $editortu->NAMA;?>" name="nama" class="form-control round-input">
                                      </div>
                                  </div>
