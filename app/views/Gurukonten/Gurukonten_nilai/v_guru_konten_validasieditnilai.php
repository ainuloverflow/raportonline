                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" action="<?php echo $url;?>validasi-edit-nilai-as-guru" method="post">
                                  ...
                                  <input type="text" name="id_nilai" value="<?php echo $validasi->value('id_nilai');?>" class="form-control round-input hidden">
                                  ...
                                  <!--<div class="form-group">
                                      ...
                                      <div class="col-sm-7">
                                          ...
                                          <input type="text" id="id_mapel" value="<?php //echo $validasi->value('id_mapel');?>" name="id_mapel" class="form-control round-input">
                                      </div>
                                  </div>-->
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-7">
                                          <p><?php echo $validasi->errorMessages('nilai_ahkir', '<p style="color:red">', '</p>');?></p>
                                          <input type="text" value="<?php echo $validasi->value('nilai_ahkir');?>" name="nilai_ahkir" class="form-control round-input">
                                      </div>
                                  </div>
                                  <!--<div class="form-group">
